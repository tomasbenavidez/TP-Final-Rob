...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            # Se ejecutan con: ros2 run tp_a_slam_aruco <nombre>
            'aruco_detector = tp_a_slam_aruco.aruco_detector_node:main',
            'odometry = tp_a_slam_aruco.odometry_node:main',
            'graph_slam = tp_a_slam_aruco.graph_slam_node:main',
            'occupancy_grid = tp_a_slam_aruco.occupancy_grid_node:main',
            'tf_bridge = tp_a_slam_aruco.tf_bridge_node:main',
            'check_bag_contract = tp_a_slam_aruco.check_bag_contract:main',
        ],
    },
)
